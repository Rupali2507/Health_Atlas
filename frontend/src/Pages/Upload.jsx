...
  }, [results, sortConfig]);
  ...
  // --- 3. NEW: Function to handle sort requests ---
...
          {/* Upload Section */}
          {!isFinished && (
            // ... (rest of your upload section JSX is unchanged)
            <div
...
          {/* Live Log */}
          {isLoading && (
            // ... (rest of your live log JSX is unchanged)
            <div
              className={`border rounded-2xl p-5 sm:p-8 shadow-sm mb-6 ${cardBg}`}
            >
...
                  </thead>
                  <tbody>
                    {/* --- 5. NEW: Map over the sorted list --- */}
